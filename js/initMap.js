...
function initMap() {
    map = new google.maps.Map(document.getElementById('map'), {
        zoom: 15,
        center: { lat: 39.984702, lng: 116.318417 },
        streetViewControl: false,
        mapTypeControl: false
    });

    placeMarker({ lat: 39.984702, lng: 116.318417 });
    placeMarker({ lat: 39.984683, lng: 116.31845 });
    placeMarker({ lat: 39.984686, lng: 116.318417 });
    placeMarker({ lat: 39.984688, lng: 116.318385 });
    placeMarker({ lat: 39.984655, lng: 116.318263 });
